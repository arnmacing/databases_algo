...
public final class PerfectHashingBenchmark_buildIndex_jmhTest {
            ...
            if (control.isLastIteration()) {
                if (PerfectHashingBenchmark_BuildState_jmhType.tearTrialMutexUpdater.compareAndSet(l_buildstate1_G, 0, 1)) {
                    try {
                        ...
                        PerfectHashingBenchmark_BuildState_jmhType.tearTrialMutexUpdater.set(l_buildstate1_G, 0);
                    }
                } else {
                    long l_buildstate1_G_backoff = 1;
                    while (PerfectHashingBenchmark_BuildState_jmhType.tearTrialMutexUpdater.get(l_buildstate1_G) == 1) {
    ...
    static volatile PerfectHashingBenchmark_BuildState_jmhType f_buildstate1_G;
    
    PerfectHashingBenchmark_BuildState_jmhType _jmh_tryInit_f_buildstate1_G(InfraControl control) throws Throwable {
        PerfectHashingBenchmark_BuildState_jmhType val = f_buildstate1_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = new PerfectHashingBenchmark_BuildState_jmhType();
            Field f;
            f = bench.PerfectHashingBenchmark.BuildState.class.getDeclaredField("n");
